...
public class ArtifactItems {
    ...
    public static final RegistryObject<Item> ADZE_OFANNAM = ARTIFACTS.register("axe_of_adze", () -> new AxeItem(ModToolTiers.ARTIFACT_TOOL, 1000, 0, new Item.Properties()));
    ...
    public static final RegistryObject<Item> BLADE_OF_AVERNUS = ARTIFACTS.register("blade_of_avernus", () -> new AxeItem(ModToolTiers.ARTIFACT_TOOL, 1000, 0, new Item.Properties()));
    public static final RegistryObject<Item> BLADE_OF_BROKEN_MIRRORS = ARTIFACTS.register("blade_of_broken_mirrors", () -> new AxeItem(ModToolTiers.ARTIFACT_TOOL, 1000, 0, new Item.Properties()));
    public static final RegistryObject<Item> DEKELLA_BIDENT_OF_THASSA = ARTIFACTS.register("dekella_bident_of_thassa", () -> new AxeItem(ModToolTiers.ARTIFACT_TOOL, 1000, 0, new Item.Properties()));
    ...
    public static final RegistryObject<Item> SILKEN_SPITE = ARTIFACTS.register("silken_spite", () -> new AxeItem(ModToolTiers.ARTIFACT_TOOL, 1000, 0, new Item.Properties()));
    public static final RegistryObject<Item> SWORD_OF_KAS = ARTIFACTS.register("sword_of_kas", () -> new AxeItem(ModToolTiers.ARTIFACT_TOOL, 1000, 0, new Item.Properties()));
    public static final RegistryObject<Item> SWORD_OF_ZARIEL = ARTIFACTS.register("sword_of_zariel", () -> new AxeItem(ModToolTiers.ARTIFACT_TOOL, 1000, 0, new Item.Properties()));
    ...
    public static final RegistryObject<Item> WILL_OF_THE_TALON = ARTIFACTS.register("will_of_the_talon", () -> new AxeItem(ModToolTiers.ARTIFACT_TOOL, 1000, 0, new Item.Properties()));
